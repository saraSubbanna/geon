...
class DraggableViewBackground: UIView, DraggableViewDelegate, UISearchBarDelegate, UIPickerViewDelegate {
    ...
    override init(frame: CGRect) {
        ...
        self.setupView()
        storeNames = ["McDonalds", "Peete's Coffee Shop", "Tom's Magic Shop", "Angel Hack", "Dignita"]
        // all types
        loadedCards = []
        cardsLoadedIndex = 0
        self.loadCards()
    ...
    func setupView() -> Void {
        ...
        filters_radius.setImage(UIImage(named: "distance"), forState: UIControlState.Normal)
        ...
        filters_locations.setImage(UIImage(named: "type"), forState: UIControlState.Normal)
